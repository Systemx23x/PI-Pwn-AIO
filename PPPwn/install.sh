...
while true; do
read -p "$(printf '\r\n\r\n\033[36mWould you like to Change Payloads, the default is 11.00\r\n\r\n\033[36m(Y|N)?: \033[0m')" plset
case $plset in
[Yy]* ) 
while true; do
read -p  "$(printf '\033[33mEnter the Firmware Version of the Payloads [ 4.00-7.00 | 5.05 | 6.72 | 9.00 | 11.00 ]: \033[0m')" PLV
case $PLV in
[4.00-7.00]* )
while true; do
...
if grep -q '^[0-9.]*$' <<<$PLV ; then 
if [[ ! "$PLV" =~ ^("4.00-7.00"|"5.05"|"6.72"|"9.00"|"11.00")$ ]]  ; then
echo -e '\033[31mThe version must be [ 4.00-7.00 | 5.05 | 6.72 | 9.00 | 11.00 ]\033[0m';
else 
break;
fi
else 
...
echo -e '\033[32mYou are using '$PLV'\033[0m'
break;;
[Nn]* ) 
echo -e '\033[35mUsing the default setting: 11.00\033[0m'
PLV="11.00"
